...
In the second phase of the project, we extended the delivery of the first phase to use the docker container to deploy the application as three interactive containers:
- Frontend Container
